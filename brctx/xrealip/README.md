## How to install/update X-Real-Ip
  ...
  1. If you have an active previous version of `X Real IP`, go to the Admin Control `Panel -> Customise -> Manage extensions`
  2. Disable the extension `X Real IP` (do not click "delete data" to keep all your configured questions and answers)
  3. Delete folder `ext/brctx/xrealip`
